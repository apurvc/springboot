...
public class QuoteController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/random", produces = "application/vnd.sapient.app-v1+json")
	public QuoteV1 getQuote() {
		return quoteService.getSimpleQuote();
	}
	
	@RequestMapping(method = RequestMethod.GET, value = "/{quoteId}", produces = "application/vnd.sapient.app-v1+json")
	public QuoteV1 getQuoteById(@PathVariable("quoteId") String quoteId ) {
		return quoteService.getQuoteV1ById(quoteId);
	}

	@RequestMapping(method = RequestMethod.GET, value = "/random", produces = "application/vnd.sapient.app-v2+json")
